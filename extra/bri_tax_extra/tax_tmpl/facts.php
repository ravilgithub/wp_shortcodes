<?php
	...
	class Facts {
		...
		public function add_tmpl_assets() {
			wp_enqueue_style( 'facts-tmpl-css' );
			wp_enqueue_script( 'facts-tmpl-js' );
		}
...
?>
			...
			<!-- <section
				...
				class="bri-facts-tmpl section facts-page <?php // echo $class ?>"
			...
			<section
				id="<?php echo esc_attr( $this->id ); ?>"
				class="bri-facts-tmpl section facts-page parallax-window <?php echo $class ?>"
