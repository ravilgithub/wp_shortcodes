...
/**
 * Класс реализует шорткод "bri_tax",
 ...
 * @author Ravil
 */
class Bri_Tax_Shortcode extends Bri_Shortcodes {
	public $name          = 'bri_tax';
	public $assets        = [];
	...
	public function add_ajax() {
		wp_localize_script(
			...
			[
				...
				'nonce' => wp_create_nonce( 'bri_tax_tmpl_ajax_nonce' )
			]
		);
	}
	 ...
	 *
	 * Функция обработчик шорткода "bri_tax".
	 *
	 ...
	 * @author Ravil
	 */
	public function shortcode_bri_tax( $atts, $content, $tag ) {
   ...
   *   }
	...
	public function get_more_posts() {
		...
		if ( ! wp_verify_nonce( $_GET[ 'nonce' ], 'bri_tax_tmpl_ajax_nonce' ) ) {
