...
/**
 * Класс реализует шорткод "briz_link",
 ...
 * @author Ravil
 */
class Briz_Link_Shortcode extends Briz_Shortcodes {
	public $name   = 'briz_link';
	public $assets = [
		'css' => [
			'briz_link' => [
				'deps' => [],
	 ...
	 *
	 * Функция обработчик шорткода "briz_link".
	 *
	 ...
	 * @author Ravil
	 */
	public function shortcode_briz_link( $atts, $content, $tag ) {
